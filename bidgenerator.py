...
st.set_page_config(page_title="Bid Creation Bot ", layout="wide")
...
st.markdown("""
    ...
    <p class="animated-gradient-text">
        Bid Creation Bot: A Bid Generation Tool!
    </p>
""", unsafe_allow_html=True)
...
def user_input(user_question, api_key):
    with st.spinner("Writing Bid Document..."):
                ...
                html_string ='''
                            <!DOCTYPE html>
                                ...
                                <body>
                                    ...
                                    <div class="header">
                                    <h1>Bid Creation Bot: A Bid Generation Tool!</h1>
                                    </div>
                                    <div class="subtitle">
                                    <h3>''' + para_title + '''</h3>
                                    </div>
                ...
                @st.experimental_dialog("Edit the bid document", width= 'large')
                def edit_report():
                    output_ = st.text_area("Edit bid report", html_string)
                    if st.button("Submit"):
                        ...
                        st.write("Bid Generated Successfully. Please check directory ", fileName)
                        st.success("Bid Document Delivered to the location !!!")
                        st.rerun()
                edit_report()
                st.success("Bid Document Delivered to the location !!!")
...
with open(fname, "rb") as f:
    st.download_button("Download bid document from here!!", f, fname)
...
def main():
    ...
    user_question = st.text_input("What bid document do you want to generate?", key="user_question")
    if user_question:
        m = st.markdown("""
        <style>
